public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("number1.getAuthor().firstName = " + number1.getAuthor().firstName);
        System.out.println("number1.getAuthor().lasstName = " + number1.getAuthor().lastName);
        ...
        System.out.println("number2.getAuthor().firstName = " + number2.getAuthor().firstName);
        System.out.println("number2.getAuthor().lasstName = " + number2.getAuthor().lastName);
